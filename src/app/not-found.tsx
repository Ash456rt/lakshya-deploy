  ...
  return (
    <main className="min-h-screen bg-paper text-ink flex items-center justify-center px-6">
      <div className="text-center max-w-lg">
        ...
        <h1 className="text-6xl md:text-8xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-brand-violet to-brand-violet-light">
          404
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/"
            className="px-8 py-3 rounded-full bg-accent hover:bg-accent-strong text-ink font-semibold transition-colors"
          >
            Go Home
          </Link>
          <Link
