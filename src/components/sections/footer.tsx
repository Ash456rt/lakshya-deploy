...
const footerLinks = {
  Services: [
    { name: "App & Web Development", href: "#services" },
    { name: "Strategic Consultancy", href: "#services" },
    { name: "Import & Export", href: "#services" },
    { name: "Customer Support", href: "#services" },
    { name: "Transport & Logistics", href: "#services" },
    { name: "Tours & Travel", href: "/travels/index.html#packages" },
    { name: "Lakshya Academy", href: "/lakshya-deploy/courses.html" },
  ],
  Platforms: [
    { name: "Lakshya Academy", href: "/lakshya-deploy/index.html" },
    { name: "Academy Courses", href: "/lakshya-deploy/courses.html" },
  ...
  Legal: [
    { name: "Privacy Policy", href: "/lakshya-deploy/privacy.html" },
    { name: "Terms of Service", href: "/lakshya-deploy/terms.html" },
    { name: "Refund Policy", href: "/lakshya-deploy/refund.html" },
  ],
};
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            ...
            <div className="space-y-2 text-sm text-neutral-400 mb-6">
              ...
              >
                <span>📧</span> admin@lakshyagroups.in
              </a>
              <a
                href="tel:+919902841875"
                className="flex items-center gap-2 hover:text-white transition-colors"
              >
                <span>📞</span> +91 99028 41875
              </a>
